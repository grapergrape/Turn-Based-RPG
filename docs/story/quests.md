...
- **Act IV:** The Choir Revealed. The cult becomes a full society and a strategic threat, ending with the abduction of Pontifex Celestine IV and the Devil manifestation.
- **Act IV:** Woundfall. The final descent to Father Vale and Seneca, where the player decides what survives of the lock.
...
**Key characters:** Player, Junia Carbo, checkpoint Choir boss, Hallowfen smugglers, scavengers, illegal settlers, possible first contact with Perpetua or Theophilus.
...
**Scale target:** Act I should plan for at least **180,000 authored map tiles**, roughly fifty times the current Ash Chapel tutorial footprint. The current plan reaches **197,308 tiles** after the Ash Road South and Old Pilgrim Way helper maps are included. This does not mean one huge map. It should be built as linked road, checkpoint, district, interior, and siege levels so the player feels regional distance without forcing every system to carry one massive scene.
...
**Transition to the archive plot:** After Hallowfen, the recovered data core forces the first main-lore decision: give it to the Holy Remnant, give it to the Lumen Compact, sell it in Spindle Gate, or keep it. Decoding it reveals Seneca's damaged warning and points toward the Three Witnesses through puzzle clues rather than exact coordinates.
...
Early player-facing text should call it the **blackened core**, **reliquary core**, or **ship-cube**. It should not be called Seneca's black box before decoding. The pickup should create pressure rather than answers. The warning plays only after partial decoding, and that decode leads into the Remnant, Compact, Spindle Gate, or keep-it-hidden choice.

**Act I regional map budget:** Planned total: **197,308 tiles**.
...
- **Ash Road South surface:** 130x80, 10,400 tiles. South Measure is a permanent settlement still classified as a Bloom refugee camp. Its sound condenser is throttled because full flow wakes an Intake Clerk and repeats a dead Hallowfen checkpoint code. The operating plans introduce Morrow Chain debt rule, Compact reintegration promises, and Brother Cassian's pursuit of the signal. See `docs/story/locations/ash-road-south.md`.
- **Ash Road South helper maps:** 8,004 tiles across the intake undercroft, relief drain, maintenance annex, faction interiors, civic spaces, selected homes, and the charity cellar. These maps keep the 130x80 surface readable while giving restricted and subterranean spaces room to work.
- **Old Pilgrim Way:** 120x70, 8,400 tiles. Current road clergy manage a field closure while the South Measure outcome follows the party north.
- **Old Pilgrim Way helper maps:** 9,304 tiles across the Hill Church, Closure Stair, Novitiate Quarters, Trial Galleries, and Sealed Chapter. The route records a pre-Bloom Solar Ecclesiate congregation killed by its own automatic protection system.
...
- **Road Warden Tobias:** 90x70, 6,300 tiles. Road wardens and Remnant doubts give the first hard proof that the Hallowfen perimeter is failing.
...
- **Spindle Gate Road Outskirts:** 80x40, 3,200 tiles. Free City agents and smugglers open the exit route to the Act II political world.

**Implemented Old Pilgrim Way quests:**

- `road-through-the-fields` begins with Sister Thecla's road closure. The party
  questions Tobias Faber, searches the east furrows, fights five Stage IV forms,
  reports the count, and opens the route toward Quarantine Farms. Host Signs or
  Search can identify the opening body before combat and grant one prepared
  sidearm shot.
- `the-buried-novitiate` remains hidden until the church's closure route is
  proven. Doctrine or Search establishes the raised apse discrepancy, while
  Engineering or Security releases the concealed door. The party opens the
  inner pressure seal, reads the last water tally, completes four mechanical
  profession trials, opens the body-free Oath Armory, takes the Processional
  Pike, and leaves through the return lift.
- The buried dead are priests, sisters, novices, and sheltered pilgrims. They
  are ordinary skeletons, not enemies. The automatic seal prevented Bloom
  contamination, then stranded the congregation without water or release.

**Faction discovery order:**

1. **Holy Remnant and Ashen Censure:** Censure Road Camp, Road Warden Tobias, Shrine Rows and Bell Yard.
...
Seneca's recording does not say where to go in plain words. It gives clues that only make sense after fieldwork. The player follows rumors, old maps, doctored Remnant records, Compact medical tags, drowned bell codes, market gossip, and companion knowledge until each Witness location becomes legible.
...
- **The Bell in the Water:** Who made the Stilling lock, and why can Seneca no longer save it?
...
- Reach Cardinal Domitilla Corvus and the Quiet Cardinals.
- Steal, bargain for, or protect the Confessor's Key.
- Escape or survive Marshal-Confessor Victorinus if the secret is exposed.

**Branching outcomes:** The player can expose the Remnant's lie, trade the Key to Celestine for protection, preserve the Quiet Cardinals' secrecy, or leak the evidence through Free City channels.
...
**Branching outcomes:** Supporting Dr. Theophilus Celsus can expose Compact crimes and weaken Director Celsa. Supporting Celsa can preserve containment resources but bury victims. Supporting Dr. Lucian Varro can unlock dangerous Host-integration options.
...
The archive fragment contains Seneca's confession that the Stilling was a lock made from the Vale Imprint. Seneca used old Ecclesiate systems, machine choirs, orbital mirrors, confession networks, and infected tissue relays to loop Vale's terror back into the Host until the organism could no longer grow beyond that pattern.

The key revelation: Seneca created the lock and saved humanity, but calcified during the Stilling. Seneca is fused into the lock network, unable to move and unable to repair what is failing.
...
- Choose whether to help Councilor Ruth Aemilia expose the pact.
...
**Act II endpoint:** Once all three Witnesses are recovered, the player has enough truth to understand Seneca's warning. The Host did not become Hell by nature. Vale's fear gave it the grammar, and Seneca made that grammar into a prison. The lock is failing because the prison is no longer holding.
...
After the Three Witnesses, the truth is dangerous enough to move armies. Before any faction can fully act on it, **Pontifex Celestine IV is abducted**. The scene is not an ordinary kidnapping. A moon sigil is left behind, unfamiliar to most Remnant investigators but recognizable to the player through the Witness trail and earlier Choir evidence.
...
- Thecla's doctrine that a complete immersion can summon the Devil into the world.
...
- **Choir Initiation:** Join Thecla or cooperate long enough to understand the rite from inside.
...
**Gameplay purpose:** Deliver the final descent, faction consequences, Seneca's defense systems, the First Icon, and the ending choice.
...
- Find Seneca calcified into the lock network, fused to the walls and unable to move.
- Find Father Vale with Seneca, not as a distant myth but as the prisoner and torturer at the heart of the same chamber.
- Learn the final truth: Seneca looped Vale's fear back through the Host to create the Stilling lock. That act saved humanity by making the Host repeat Vale's Hell forever.
- Understand Vale's motive. He wants the Stilling broken because the lock is also his eternal torture.

Seneca is not a clean villain. Vale is not a clean victim. Seneca saved the world by doing something unforgivable to one terrified man. Vale is right to hate Seneca, and Vale's escape may still doom everyone else.

**Endgame choices:**

- **Side with Vale:** Fight Seneca's automations, machine-choir defenses, and lock guardians to free the First Icon. This may lead to an Open Wound outcome even if Thecla was defeated.
- **Side with Seneca or the lock:** Fight the monstrous, partially lucid Father Vale and preserve or restore containment.
...
- **Kill both:** Sever Vale and Seneca from the system. Depending on faction preparation, this can become brutal lock renewal, partial collapse, or the cult's victory after its leaders are gone.
...
- **Cure Ending:** The Compact uses Seneca's work and the Witnesses to stabilize treatment while preserving enough of the lock to prevent another Bloom.
...
- **Lock Renewed Ending:** Vale, Seneca, a companion, or the player becomes the price of continued containment.
...
**Primary NPCs:** Pontifex Celestine IV, Sister Perpetua, Cardinal Domitilla Corvus, Marshal-Confessor Victorinus, Mother Agnes.
...
- Protect or expose Cardinal Domitilla's forbidden archive.
- Stop Victorinus from burning a settlement based on incomplete evidence.
- Help Celestine unify forces for Woundfall at the cost of truth.

### Lumen Compact: Truth's Altar

**Primary NPCs:** Director Theodora Celsa, Dr. Theophilus Celsus, Dr. Lucian Varro, Provost Cassia Priscian.
...
**Primary NPCs:** Warden Deborah Porta, Councilor Ruth Aemilia, Prior Benedict, Speaker Junia Felix, Junia Carbo.
...
- Negotiate Spindle Gate entry for Hallowfen survivors, fugitives, and smugglers who survived the siege.
...
**Primary NPCs:** Cantor Thecla Naso, Matthias Nauta, Brother Malachi, Mothers of Open Gates.
...
- Track Brother Malachi's hunt for Vale relics.
...
- Resolve Matthias's temptation to return.

### Penitent Engines: Steel Remembers

**Primary NPCs:** Brother Cassian, Abbess-Mechanic Helena, Prior-Iron Severus.
...
- Choose whether Cassian obeys an order to seize Bloomborn children.
- Stop Severus from starting a private crusade.
...
**Primary NPCs:** Junia Carbo, Judith Cotta, Bishop Rufinus, Gideon Naso.
...
- Buy stolen Remnant records from Gideon Naso.
- Decide who controls the roads during Act III evacuations.

### Bloomborn: Names on the Ledger

**Primary NPCs:** Mica, Miriam Porta, Old Keziah.

**Arc:** The player decides whether altered humans are citizens, patients, weapons, evidence, miracles, or threats.

**Possible quests:**

- Help Mica seek citizenship without state ownership.
- Protect Miriam's hidden ledger of Bloomborn disappearances.
...
- **Junia Carbo:** The Morrow Chain can save a refugee column only by using routes tied to prisoner smuggling.
- **Sister Perpetua:** A Mercy Order hospice is exposed, and obedience would mean delivering patients to fire.
- **Dr. Theophilus Celsus:** The sealed lab he abandoned contains living subjects who remember his voice.
- **Brother Cassian:** The Black Reliquary orders him to choose duty over children.
- **Mica:** A city offers citizenship in exchange for registration as a Host-detection asset.
- **Matthias Nauta:** His old Choir cell can save condemned refugees through a rite that may also infect them.
